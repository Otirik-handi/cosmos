...
- Entity merge/dedup；批注的正文片段字符级锚点；**代码规模行数门禁已由 G08 修复**（完整口径下仍有 4 个文件超 800 行、2 个入口超 300 行；G09–G14 已拆 `packages/domain`、`media-acquisition`、`workflow-host-runtime`、`worker-admin`、`collectors` 与 `workflow-backend`）。
