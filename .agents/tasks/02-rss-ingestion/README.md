...
本节历史切片记录按提案 4.3 追加型日志规则归档为分册(每册 ≤30 KB,封口后只读);主文档保留本任务的目标、范围、当前状态与验收。

| 分册 | 范围 | 大小 |
|---|---|---|
| [slices-2026-08-23-09-02.md](readme/slices-2026-08-23-09-02.md) | 切片声明与合同切换登记(2026-08-23~24)、切片:source-config-probe、切片:schema 驱动 Web 配置(2026-09-02) | 18.3 KB |
| [slices-2026-09-03.md](readme/slices-2026-09-03.md) | 切片:两块固定看板与来源健康(2026-09-03) | 10.0 KB |
| [slices-2026-09-04-07.md](readme/slices-2026-09-04-07.md) | 切片:媒体边界与阅读/媒体路径、Run 计数缺陷发现、媒体重复下载修复(2026-09-03~09-07) | 8.6 KB |
| [slices-2026-09-15.md](readme/slices-2026-09-15.md) | 切片:搜索文本按字面处理(FTS5 语法字符 500 修复,2026-09-15) | 3.5 KB |

→ 切片声明与合同切换登记(2026-08-23~24)、切片:source-config-probe、切片:schema 驱动 Web 配置(2026-09-02) 已归档:[slices-2026-08-23-09-02.md](readme/slices-2026-08-23-09-02.md)
→ 切片:两块固定看板与来源健康(2026-09-03) 已归档:[slices-2026-09-03.md](readme/slices-2026-09-03.md)
→ 切片:媒体边界与阅读/媒体路径、Run 计数缺陷发现、媒体重复下载修复(2026-09-03~09-07) 已归档:[slices-2026-09-04-07.md](readme/slices-2026-09-04-07.md)
→ 切片:搜索文本按字面处理(FTS5 语法字符 500 修复,2026-09-15) 已归档:[slices-2026-09-15.md](readme/slices-2026-09-15.md)
